...
public class HailAddon
{
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> HA_CREATIVE_TAB = CREATIVE_MODE_TABS.register("ha_creative_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("hail_addon.creative_tab"))
            .icon(() -> ROT_WRENCH.get().getDefaultInstance())
            .displayItems((parameters, output) -> {
                output.accept(ROT_WRENCH.get());
            }).build());
